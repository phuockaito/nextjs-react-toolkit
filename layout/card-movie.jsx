...
export const CardMovie = ({ data, title, time }) => {
    return (
        <Section className="my-2">
            <h2 className="text-3xl font-semibold my-2 text-[#fefdff]">{title}</h2>
            <WrapperCarousel
                slidesPerView={8}
                spacingPerView={12}
                snapMode="free-snap"
                            ...
                            <div className="text-left">
                                ...
                                <div className="flex gap-1 items-center justify-between">
                                    <h3 className="flex gap-1 items-center">
                                        ...
                                        <p className="sm:text-base text-[13px] text-amber-400">{item.vote_average}</p>
                                    </h3>
                                    <h3 className="flex gap-1 items-center">
                                        <FcLike className="sm:text-base text-[13px]" />
                                        <p className="sm:text-base text-[13px] text-[#fefdff]">{item.vote_count}</p>
                                    </h3>
                                </div>
